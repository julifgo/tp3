...
namespace dcnet{
	...
	private:
		...
		Conj<Lista<Compu>> CaminosQueEmpiezanConPcx(const Conj<Lista<Compu>>& caminos, const Nat& pcx) const;
		
		//caminosQueTerminanConPcx
		Conj<Lista<Compu>> CaminosQueTerminanConPcx(const Conj<Lista<Compu>>& caminos, const Nat& pcx) const;
